...
//		with new keyword:
//		when you are not sure about the values, like u declare 10 segments but u have only 4 values at first
		int i[] = new int[10];// 0-9

//		Array literals: without new keyword ,when you are already having the values in advance
//		when you are sure about the values
